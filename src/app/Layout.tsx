...
export function Layout() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-['Space_Grotesk',sans-serif]" style={{ position: "relative" }}>
      <header className="fixed top-0 left-0 bottom-0 z-50 p-6 flex flex-col items-start gap-6 pointer-events-none">
        <nav className="flex flex-col gap-3 pointer-events-auto bg-[#152028]/90 backdrop-blur-md p-3 rounded-[40px] border-2 border-white/10 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] items-start transition-all duration-300">
          <Link to="/" className="size-[56px] bg-[#152028] rounded-full shrink-0 flex items-center justify-center text-white text-[20px] font-bold tracking-[-1px] border-2 border-[#ff6d1f] drop-shadow-[2px_2px_0_#ff6d1f] hover:drop-shadow-[4px_4px_0_#ff6d1f] hover:-translate-y-[1px] hover:-translate-x-[1px] transition-all font-['Space_Grotesk',sans-serif] z-10 relative mb-1">
            TC.
          </Link>
          <Link to="/" className="group flex items-center rounded-full hover:bg-[#FF6D1F] transition-all duration-300 overflow-hidden text-zinc-300 hover:text-[#152028] ml-2">
          ...
          <a href="#about" className="group flex items-center rounded-full hover:bg-[#FF6D1F] transition-all duration-300 overflow-hidden text-zinc-300 hover:text-[#152028] ml-2">
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 20 20">
          ...
          <a href="#portfolio" className="group flex items-center rounded-full hover:bg-[#FF6D1F] transition-all duration-300 overflow-hidden text-zinc-300 hover:text-[#152028] ml-2">
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 20 20">
          ...
          <Link to="/blog" className="group flex items-center rounded-full hover:bg-[#FF6D1F] transition-all duration-300 overflow-hidden text-zinc-300 hover:text-[#152028] ml-2">
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
          ...
          <a href="mailto:Tomcarter90@gmail.com" className="group flex items-center rounded-full hover:bg-[#FF6D1F] transition-all duration-300 overflow-hidden text-zinc-300 hover:text-[#152028] ml-2">
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 20 20">
      ...
      <main className="flex-1 w-full max-w-[1600px] pl-24 pr-4 sm:pl-[104px] sm:pr-8 pt-12 sm:pt-16 pb-24 mx-auto" style={{ position: "relative" }}>
        <Outlet />
      </main>

      <footer className="w-full max-w-[1600px] mx-auto pl-24 pr-4 sm:pl-[104px] sm:pr-8 py-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-zinc-500">
